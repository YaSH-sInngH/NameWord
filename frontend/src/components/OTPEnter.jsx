...
const OTPEnter = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-[rgba(94,48,204,0.05)] to-[rgba(9,135,255,0.05)] flex flex-col items-center relative px-4 sm:px-6 lg:px-8 xl:px-0">
      {/* Top Bar */}
      <div className="flex justify-between items-center w-full max-w-[1376px] h-6 mt-6 absolute left-1/2 -translate-x-1/2 top-0 z-20 px-4 sm:px-6 lg:px-8 xl:px-0">
      ...
      <div className="relative w-full max-w-[1376px] mt-[100px] sm:mt-[150px] lg:mt-[200px] px-4 sm:px-6 lg:px-8 xl:px-0">
        {/* Map Image - Hidden on mobile, shown on larger screens */}
        <img
          src={mapBaseImg}
          alt="Map Background"
          className="hidden sm:block w-full h-[300px] sm:h-[400px] lg:h-[471px] object-contain rounded-[24px]"
        />
        
        {/* OTP Card */}
        <div className="relative sm:absolute sm:left-1/2 sm:-translate-x-1/2 sm:top-[-40px] flex flex-col items-center w-full max-w-[550px] mx-auto bg-white rounded-[24px] shadow-lg z-10 py-[32px] sm:py-[48px] px-[24px] sm:px-[40px] gap-4 sm:gap-6">
          {/* Icon */}
          <div className="w-[48px] h-[48px] sm:w-[56px] sm:h-[56px] bg-[#6637D0] rounded-2xl flex items-center justify-center mb-2">
            <svg width="60" height="60" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg" className="sm:w-[68px] sm:h-[68px]">
          ...
          {/* Title & Subtitle */}
          <h2 className="text-xl sm:text-2xl font-bold text-black mb-1 text-center">Enter OTP code</h2>
          <p className="text-sm sm:text-base text-[#505050] text-center mb-1 px-2">
          ...
          {/* OTP Inputs */}
          <div className="flex justify-center gap-3 sm:gap-4 w-full mb-2">
            {otp.map((val, idx) => (
              <input
                key={idx}
                ref={inputRefs[idx]}
                ...
                className="w-[56px] h-[56px] sm:w-[64px] sm:h-[64px] text-2xl sm:text-3xl text-center border-2 border-[#6637D0] rounded-[12px] focus:outline-none focus:ring-2 focus:ring-[#9664E6] font-bold text-[#1C1E40] bg-white transition-all"
                autoFocus={idx === 0}
              />
            ))}
          </div>
