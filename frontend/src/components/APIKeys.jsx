        ...
        <div className="max-w-[1188px] mx-auto">
          <div className="pt-6 lg:pt-10 mb-6 lg:mb-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <h1 className="text-2xl md:text-3xl font-bold text-[#1C1E40]">API Keys</h1>
              <button className="w-full sm:w-auto pt-[14px] pb-[14px] px-6 rounded-full border border-[#7C3AED] text-[#9664E6] font-semibold bg-white hover:bg-[#F7F3FF] transition">API Key Rotation</button>
            </div>
          </div>
          <div className="bg-white rounded-[12px] lg:rounded-[16px] p-4 sm:p-5 lg:p-6 shadow-sm w-full">
            <div className="flex items-center justify-between mb-4">
              <div className="text-lg sm:text-xl md:text-2xl font-semibold text-[#1C1E40]">List of API keys</div>
                ...
                <tbody>
                  {apiKeys.map((key, idx) => (
                    <tr key={idx} className="border-b border-[#EAEAEA] hover:bg-[#F9FAFC]">
                      ...
                      <td className="py-3 px-2">
                        <div className="flex items-center gap-2">
                          <button className="text-[#7C3AED] text-base font-medium flex"><span className='pr-2'>
                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg"><g clipPath="url(#clip0_8366_174027)"><path d="M10.6172 0.5C5.0902 0.5 0.617188 4.9725 0.617188 10.5C0.617188 16.0269 5.08969 20.5 10.6172 20.5C16.1442 20.5 20.6172 16.0275 20.6172 10.5C20.6172 4.97309 16.1447 0.5 10.6172 0.5ZM10.6172 19.1046C5.87258 19.1046 2.01254 15.2446 2.01254 10.5C2.01254 5.75535 5.87258 1.89535 10.6172 1.89535C15.3618 1.89535 19.2218 5.75535 19.2218 10.5C19.2218 15.2446 15.3618 19.1046 10.6172 19.1046Z" fill="#9664E6"/><path d="M10.6151 8.83594C10.0228 8.83594 9.60156 9.08609 9.60156 9.45465V14.4697C9.60156 14.7857 10.0228 15.1015 10.6151 15.1015C11.1811 15.1015 11.6418 14.7857 11.6418 14.4697V9.45457C11.6418 9.08605 11.1811 8.83594 10.6151 8.83594Z" fill="#9664E6"/><path d="M10.6184 5.74268C10.0129 5.74268 9.53906 6.17705 9.53906 6.67725C9.53906 7.17748 10.0129 7.62502 10.6184 7.62502C11.2107 7.62502 11.6846 7.17748 11.6846 6.67725C11.6846 6.17705 11.2107 5.74268 10.6184 5.74268Z" fill="#9664E6"/></g><defs><clipPath id="clip0_8366_174027"><rect width="20" height="20" fill="white" transform="translate(0.617188 0.5)"/></clipPath></defs></svg></span>Details</button>
                          <button className="text-[#F04438] hover:bg-[#FDECEC] rounded-full p-2 transition" title="Delete">
                            <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12.7812 3.49984H16.9479V5.1665H15.2812V15.9998C15.2812 16.4601 14.9082 16.8332 14.4479 16.8332H2.78125C2.32102 16.8332 1.94792 16.4601 1.94792 15.9998V5.1665H0.28125V3.49984H4.44792V0.999837C4.44792 0.539604 4.82102 0.166504 5.28125 0.166504H11.9479C12.4082 0.166504 12.7812 0.539604 12.7812 0.999837V3.49984ZM13.6146 5.1665H3.61458V15.1665H13.6146V5.1665ZM6.11458 7.6665H7.78125V12.6665H6.11458V7.6665ZM9.44792 7.6665H11.1146V12.6665H9.44792V7.6665ZM6.11458 1.83317V3.49984H11.1146V1.83317H6.11458Z" fill="#FC5585"/></svg>
                          </button>
                        </div>
                      </td>
                    </tr>
