...
const Login = () => {
  ...
  return (
    <main className="w-full bg-white">
      ...
      {/* Two-column layout */}
      <div className="flex w-full h-[1024px] bg-white overflow-hidden">
      {/* Left: Sign In Section */}
        <div className="flex flex-col w-[700px] h-full px-8 lg:px-16 py-8 justify-between bg-white">
        {/* Top: Go back and Logo */}
          <div className="flex items-center justify-between w-full max-w-[636px] h-10">
            {/* Go back button */}
            <button 
              className="flex items-center text-black text-lg font-korolevLight hover:text-[#3E239E] transition-colors" 
              onClick={() => navigate('/')}
            >
            ...
            {/* Spacer div - can be removed if not needed */}
            <div className='w-[105px] h-[24px]'></div>
        </div>

        {/* Center: Sign In Form */}
          <form onSubmit={handleSubmit} className="flex flex-col items-center w-[553px] mx-auto space-y-6">
            <h1 className="text-[2.5rem] font-northura text-black text-center">Sign In</h1>
          ...
          {/* Email Input */}
            ...
            <input
              type="email"
                ...
                className="w-full h-[55px] px-4 py-2 border rounded-lg text-base text-black focus:outline-none focus:ring-2 focus:ring-[#3E239E] focus:border-[#3E239E] transition-all duration-200"
          ...
          {/* Password Input */}
            ...
            <input
                  ...
                  onChange={handleInputChange}
                  className="w-full h-[55px] px-4 py-2 pr-12 border rounded-lg font-korolev text-base text-black focus:outline-none focus:ring-2 focus:ring-[#3E239E] focus:border-[#3E239E] transition-all duration-200"
          ...
          {/* Sign In Button */}
            <button 
              type="submit"
              className="w-full h-[55px] rounded-full bg-gradient-to-r from-[#3E239E] to-[#8B7BC5] text-white text-lg font-northuraHeavy hover:shadow-lg transform hover:scale-[1.02] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#3E239E] focus:ring-offset-2"
          ...
          {/* Social Buttons */}
            <button 
              type="button"
              className="w-full h-[48px] rounded-lg border border-[#EAEAEA] flex items-center justify-center gap-3 text-black text-base font-medium hover:bg-gray-50 transition-colors duration-200"
            >
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      {/* Right: Image Section */}
        <div className="hidden lg:block relative w-[540px] md:w-[740px] h-full bg-white left-[15px] top-[15px]">
        {/* Background image with overlay */}
          <div className="absolute w-[540px] md:w-[708px] h-[700px] md:h-[992px]">
            <img 
        ...
        {/* Overlayed content */}
            <div className="relative z-10 flex flex-col justify-center h-[222px] w-[612px] p-12 top-[630px]">
              <div className="mt-32">
                <h2 className="text-white font-northuraHeavy text-4xl leading-tight mb-8 drop-shadow-lg">
